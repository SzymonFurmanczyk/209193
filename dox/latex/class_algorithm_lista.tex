...
\index{Algorithm\+Lista@{Algorithm\+Lista}!Algorithm\+Lista@{Algorithm\+Lista}}
...
\hypertarget{class_algorithm_lista_a2d7c5ef95cdfe523a86b01da06d0fb2e}{}\index{Algorithm\+Lista@{Algorithm\+Lista}!````~Algorithm\+Lista@{$\sim$\+Algorithm\+Lista}}
\index{````~Algorithm\+Lista@{$\sim$\+Algorithm\+Lista}!Algorithm\+Lista@{Algorithm\+Lista}}
...
\index{run\+Algorithm@{run\+Algorithm}!Algorithm\+Lista@{Algorithm\+Lista}}
...
\begin{center}
\leavevmode
\includegraphics[width=320pt]{class_algorithm_lista_a5c41dbbd3ae7a9ac34edec1a51bc8eb1_cgraph}
\end{center}
\end{figure}
...
\index{test\+Algorithm@{test\+Algorithm}!Algorithm\+Lista@{Algorithm\+Lista}}
...
\index{lista@{lista}!Algorithm\+Lista@{Algorithm\+Lista}}
...
\index{tab@{tab}!Algorithm\+Lista@{Algorithm\+Lista}}
